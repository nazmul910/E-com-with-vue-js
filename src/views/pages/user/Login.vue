...
const login = async () => {
    ...
    if (flag) {
        ...
        //user or admin route will change (future word )
        router.push('/');
    } else {
        alert('There is no users please create a new from registration');
    }
};
</script>
                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="flex justify-between">
                            ...
                            <button class="border bg-emerald-600 px-4 rounded-md font-medium text-white py-1" @click="registratiinBtn">Registration</button>
                        </div>
                    </div>
