            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Welcome to User Registration</div>
                        <span class="text-muted-color font-medium">Sign in to continue</span>
                    </div>

                    <div>
                        <label for="name" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Name</label>
                        <InputText id="name" type="text" placeholder="Enter Your Name" class="w-full md:w-[30rem] mb-8" v-model="state.name" />

                        <label for="email1" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Email</label>
                        <InputText id="email1" type="email" placeholder="Email address" class="w-full md:w-[30rem] mb-8" v-model="state.email" />
                        ...
                        <InputText id="phone" type="number" placeholder="Enter Your Phone Number" class="w-full md:w-[30rem] mb-8" v-model="state.phone" />

                        <label for="address" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Address</label>
                        <InputText id="address" type="text" placeholder="Enter Your Name" class="w-full md:w-[30rem] mb-8" v-model="state.address" />
                        <label for="birthdate" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Birthdate</label>
                        <InputText id="birthdate" type="date" placeholder="Enter Your Name" class="w-full md:w-[30rem] mb-8" v-model="state.dateofbirth" />
                        ...
                        <Button @click="createUserAccount" label="Create Account" class="w-full"></Button>
                    </div>
                </div>
            </div>
        </div>
