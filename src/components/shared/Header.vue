...
<template>
    <div class="py-6 px-6 mx-0 md:mx-12 lg:mx-20 lg:px-20 flex items-center justify-between relative lg:static">
        <a class="flex items-center" href="#">
            ...
            <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20 w-[100px]">E-Shop</span>
        </a>
        <Button
            class="lg:!hidden"
            text
        ...
        <div class="items-center bg-surface-0 dark:bg-surface-900 grow justify-between hidden lg:flex absolute lg:static w-full left-0 top-full px-12 lg:px-0 z-20 rounded-border">
            <ul class="list-none p-0 m-0 flex lg:items-center select-none flex-col lg:flex-row cursor-pointer gap-8">
                ...
                <li>
                    <RouterLink to="/productpage" class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
                        <span>Product</span>
                    </RouterLink>
                </li>
                <!-- <li>
            ...
            <div class="flex border-t lg:border-t-0 border-surface py-4 lg:py-0 mt-4 lg:mt-0 gap-2">
                ...
                <RouterLink to="/add-to-cart">
                    <Button icon="pi pi-heart" @click="buyProduct(product)" :label="state.atToCart && state.atToCart.length > 0 ? state.atToCart.length : 'No Product'" severity="help" rounded aria-label="Favorite" />

                </RouterLink>
                <!-- // as="router-link" to="/ShowBuyProduct.vue"  -->

                <div class="flex" v-if="!validUser">
